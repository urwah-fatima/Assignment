...
let personName: string = "Eric Jhonson";
...
console.log(
  personName.charAt(0).toUpperCase() +
    "ric " +
    personName.charAt(5).toUpperCase() +
    "honson"
);
...
const famousPerson: string = "Maya Angelou";

// Quote stored in a variable
console.log("Answer 04 and 05:\n");
const message: string = `${famousPerson} once said, "Courage doesn't always roar. Sometimes courage is the quiet voice at the end of the day saying, 'I will try again tomorrow.'"`;
...
function sendInvitations(guestList: string[]) {
...
console.log(
  "Unfortunately, our new dinner table won't arrive in time, so we can only invite two people."
);
...
console.log(
  "Reversing the reversed original array back to its original form:\n",
  backToOriginal
);
...
// Question-22: If you haven’t received an array index error in one of your programs yet, try to make one happen. Change an index in one of your programs to produce an index error. Make sure you correct the error before closing the program.
...
const cityCountryList: CityCountry[] = [
...
for (let new_user of new_users) {
  ...
  if (
    current_users.map((user) => user.toLowerCase()).includes(lowercase_new_user)
  ) {
    console.log(
      `Sorry, the username '${new_user}' is not available. Please choose a different username.`
    );
  } else {
...
let favorite_pizza: string[] = ["Margherita", "BBQ Chicken", "Cheesy Cheez"];
...
console.log(
  "Pizza is one of my favorite foods. I enjoy trying different toppings and flavors. Whether it's the classic Margherita, the savory Pepperoni, or the tangy BBQ Chicken, each pizza brings its own unique taste and satisfaction. I really love pizza!"
);
...
let pets: string[] = ["Horses", "Swans", "Dogs"];
...
function summarizeSandwich(...ingredients: string[]) {
...
// Question-45: Write a function that stores information about a car in a Object. The function should always receive a manufacturer and a model name. It should then accept an arbitrary number of keyword arguments. Call the function with the required information and two other name-value pairs, such as a color or an optional feature. Print the Object that’s returned to make sure all the information was stored correctly.
...
function createCar(
  ...
  // Create an object to store car information with required properties
  const car: Car = {
    manufacturer,
    model,
    ...options,
...
const car1 = createCar("Toyota", "Camry", { color: "blue", year: 2023 });
const car2 = createCar("Honda", "Civic", { sunroof: true, mileage: 30000 });
const car3 = createCar("Ford", "Mustang", { color: "red", engine: "V8" });

// Print the car objects to ensure all information is stored correctly
